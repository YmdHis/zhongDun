...
<div id="register" class="register-container">
    ...
    <router-link to="/login" slot="right"><span class="register_btn">登录</span></router-link>
    </x-header>
    <div class="container">
        ...
        <div class="form">
            ...
            <div class="form-item">
                ...
                <input type="password" placeholder="请设置新密码" class="form-inpt"  v-model="password">
            </div>
            <div class="form-item">
                <img src="../../images/sign4.png" alt="sign" class="img-sign">
                <input type="password" placeholder="再次输入新密码" class="form-inpt"  v-model="password2">
            </div>
        </div>
         <div class="login-btn" @click="toLogin" style="display:none;">在线登录</div>
         <div class="khxy" @click="agreement()" style="display:none;"><input type="radio" checked="checked">同意客户协议</div>
...
import { findPassword, yzmGet } from 'src/service/api'
...
methods: {
    ...
    yzm(){
        ...
        console.log(mobile);
        yzmGet({mobile:mobile,type:'findpassword'}).then(res=>{
            console.log(res);
            if(res.code == 1){
                this.setTime();
            }else if(res.code == 0){
    ...
    register(){
        ...
        findPassword({mobile:mobile,code:code,password:password}).then(res=>{
            console.log(res);
            if(res.code == 1){
                this.$vux.toast.show({
                    text: "修改成功",
